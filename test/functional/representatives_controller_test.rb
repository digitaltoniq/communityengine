...
class RepresentativesControllerTest < ActionController::TestCase
  ...
  def TODO_test_should_get_index
    get :index
  ...
  def TODO_test_should_get_edit_account
    login_as :quentin
  ...
  def TODO_test_should_toggle_moderator
    login_as :admin
  ...
  def TODO_test_should_not_toggle_featured_writer_if_not_admin
    login_as :quentin
    put :toggle_moderator, :id => users(:quentin)
  ...
  def TODO_test_should_toggle_featured_writer
    login_as :admin
  ...
  def TODO_test_should_get_signup_completed
    login_as :quentin
  ...
  def TODO_test_should_get_welcome_photo
    login_as :quentin  
    get :welcome_photo, :id => users(:quentin).id
    assert_response :success
  end
  
  def TODO_test_should_get_welcome_about
    login_as :quentin
    get :welcome_about, :id => users(:quentin).id
    assert_response :success
  end
  
  def TODO_test_should_get_welcome_invite
    login_as :quentin
    get :welcome_invite, :id => users(:quentin).id
    assert_response :success
  end
  
  def TODO_test_should_get_new
    get :new
    assert_response :success
  end

  def TODO_test_should_allow_signup
  ...
  def TODO_test_should_require_login_on_signup
  ...
  def TODO_test_should_require_password_on_signup
    assert_no_difference User, :count do
  ...
  def TODO_test_should_require_password_confirmation_on_signup
    assert_no_difference User, :count do
  ...
  def TODO_test_should_require_email_on_signup
    assert_no_difference User, :count do
  ...
  def TODO_test_should_render_new_form_when_signing_up_without_required_attributes
    create_user(:user => {:password => nil})
    assert_response :success
  end

  def TODO_test_should_deactivate_and_logout
    login_as :quentin
  ...
  def TODO_test_should_not_activate_nil
    get :activate, :activation_code => nil
    assert_response :redirect
  end
  
  def TODO_test_should_activate_user
  ...
  def TODO_test_should_fail_to_activate_user
    users(:quentin).activated_at = nil
  ...
  def TODO_test_should_show_user
    get :show, :id => users(:quentin).id
    assert_response :success
  end
  
  def TODO_test_should_not_show_private_user
    get :show, :id => users(:privateuser).id
    assert_response :redirect
  end

  def TODO_test_should_list_users
    get :index
  ...
  def TODO_test_should_fill_states_on_detroit_search
  ...
  def TODO_test_should_empty_states_on_berlin_search
    #state drop down not being enabled
  ...
  def TODO_test_should_show_edit_form
    login_as :quentin
    get :edit, :id => users(:quentin).id
    assert_response :success
  end
  
  def TODO_test_should_not_show_edit_form
    login_as :quentin
    get :edit, :id => users(:aaron)
    assert_redirected_to login_path
  end

  def TODO_test_should_update_user
    login_as :quentin
  ...
  def TODO_test_should_update_user_tags
    login_as :quentin
  ...
  def TODO_test_should_not_destroy_user
    login_as :aaron
    assert_no_difference User, :count do
      delete :destroy, :id => users(:quentin)
      assert_redirected_to login_path
  ...
  def TODO_test_should_never_destroy_admin
    login_as :admin
    assert_no_difference User, :count do
  ...
  def TODO_test_should_upload_avatar
    login_as :quentin
  ...
  def TODO_test_should_not_delete_existing_avatar_if_file_field_is_blank
    login_as :quentin
    put :update, :id => users(:quentin).id, :user => {}, :avatar => {:uploaded_data => fixture_file_upload('/files/library.jpg', 'image/jpg')}
    assert users(:quentin).reload.avatar.filename, "library.jpg"
  ...
  def TODO_test_should_crop_profile_photo
    login_as :quentin
  ...
  def TODO_test_should_upload_profile_photo
    login_as :quentin
  ...
  def TODO_test_should_update_account
    login_as :quentin
  ...
  def TODO_test_should_reset_password
  ...
  def TODO_test_should_remind_username
    assert_difference ActionMailer::Base.deliveries, :length, 1 do
  ...
  def TODO_test_should_resend_activation
    users(:quentin).activation_code = Digest::SHA1.hexdigest( Time.now.to_s.split(//).sort_by {rand}.join )
    users(:quentin).activated_at = nil
    users(:quentin).save!
  ...
  def TODO_test_should_not_resend_activation_for_active_user
  ...
  def TODO_test_should_not_resend_activation_for_nonexistent_user
    assert_no_difference ActionMailer::Base.deliveries, :length do
  ...
  def TODO_test_assume_should_assume_users_id
    login_as :admin
  ...
  def TODO_test_only_admin_can_assume_id
    login_as :quentin
  ...
  def TODO_test_return_admin_should_set_user_to_admin
    login_as :quentin
  ...
  def TODO_test_only_admin_can_return_to_admin
    login_as :quentin
    @request.session[:admin_id] = users(:admin).id
    post :return_admin
    assert_response :redirect
  ...
  def TODO_test_should_decrement_metro_area_count
  ...
  def TODO_test_should_increment_metro_area_count
  ...
  def TODO_test_should_get_stats_if_admin
    login_as :admin
    get :statistics, :id => users(:super_writer).id
    assert_response :success
  end

  def TODO_test_should_not_get_stats_if_not_admin
    login_as :quentin
    get :statistics, :id => users(:super_writer).id
    assert_response :redirect
  end

  def TODO_test_should_get_dashboard_with_no_friends
    login_as :aaron
  ...
  def TODO_test_should_get_dashboard_with_no_recommended_posts
    login_as :quentin
  ...
  def TODO_test_should_show_user_statistics
    login_as :admin
