class Photo < ActiveRecord::Base
  ...
  #   end
  # end
  has_default_attachment# :file => "#{Rails.root}/public/images/default_photo.gif"
  ...
  validates_presence_of :user, :if => Proc.new{|record| record.parent.nil? and !record.default }
